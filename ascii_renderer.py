...
def render_image(image_path, cols=80, font_path="/usr/share/fonts/truetype/robotomono/RobotoMono-Regular.ttf", W=20, H=40, use_color=False):
    try:
    ...
    for r in range(rows):
        ...
        for c in range(cols):
            ...
            if use_color:
                ...
                red, green, blue = cell_img_rgb.resize((1, 1), Image.Resampling.BOX).getpixel((0, 0))
